export default function NoContract() {
	return (
		<div className="lg:flex gap-6 rounded-lg bg-white border border-neutral-50 shadow">
			<span className="flex items-center rounded-t-lg lg:rounded-l-lg lg:rounded-tr-none bg-violet-600 p-4 ">
				<svg
